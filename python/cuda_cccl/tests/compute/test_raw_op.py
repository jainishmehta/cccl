...
def test_cpp_op_basic_add():
    ...
    _run_reduce_into_multistep(reducer, d_input, d_output, num_items, h_init, op)
...
def test_cpp_op_with_transform_iterator():
    ...
    _run_reduce_into_multistep(
        reducer, transform_iter, d_output, num_items, h_init, OpKind.PLUS
    )
...
def test_cpp_stateful_op_select_with_counter():
    ...
    # Run select
    _run_select_multistep(selector, d_input, d_output, d_num_selected, num_items, op)
