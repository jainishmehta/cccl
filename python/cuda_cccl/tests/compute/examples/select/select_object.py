...
temp_storage_bytes = int(
    selector(None, d_in, d_out, d_num_selected, greater_than_5, len(d_in), None)
)
...
# Execute select
selector(d_temp_storage, d_in, d_out, d_num_selected, greater_than_5, len(d_in), None)
...
selector(d_temp_storage, d_in2, d_out2, d_num_selected2, greater_than_5, len(d_in2), None)
